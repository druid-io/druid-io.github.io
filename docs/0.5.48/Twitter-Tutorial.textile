  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class=""><a href="/docs/0.9.1.1/design/index.html">Docs</a></li>
...
<!-- Stop page_header include -->
    ...
    <div class="container">
      ...
      <p> Looking for the <a href="/docs/0.9.1.1/">latest stable documentation</a>?</p>
...
pre. tar -zxvf druid-services-0.5.58.tar.gz

Not too lost so far right? That's great! If you cd into the directory:

pre. cd druid-services-0.5.58-SNAPSHOT
