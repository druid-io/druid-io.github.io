...
With Zookeeper running, return to the druid-0.9.1.1 directory. In that directory, issue the command:
...
this task, POST it to Druid in a new terminal window from the druid-0.9.1.1 directory:
