...
From the druid-0.12.3-rc1 package root, run the following commands to build a Docker image named "druid-hadoop-demo" with version tag "2.7.3":
...
From the druid-0.12.3-rc1 package root on the host, copy the `quickstart/wikiticker-2015-09-12-sampled.json.gz` sample data to the shared folder:
...
this task, POST it to Druid in a new terminal window from the druid-0.12.3-rc1 directory:
